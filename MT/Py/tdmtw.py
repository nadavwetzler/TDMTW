...
def GetPathfile():
    MT_G = str(pathlib.Path('../../GF/GFF').resolve())+'/'
    Dir = str(pathlib.Path('../../Moment_Tensor_Events').resolve())+'/'
    path2Localfaults = str(pathlib.Path('../../MT/Layers/LocalFaults.shp').resolve())
    PB_boundaries = str(pathlib.Path('../../MT/Layers/PB2002_boundaries.shp').resolve())
    LOGO = str(pathlib.Path('../../MT/Layers/Logo.png').resolve())
    pathFF = str(pathlib.Path('../../Moment_Tensor_Events').resolve())+'/.Event_List.txt'
    return Dir, MT_G, path2Localfaults, PB_boundaries, pathFF, LOGO



Dir, MT_G, path2Localfaults, PB_boundaries, pathFF, LOGO =  GetPathfile()
